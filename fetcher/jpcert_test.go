...
func TestAddArticleIDtoCveMap(t *testing.T) {
	...
	returned := addArticleIDtoCveMap(cves, models.ArticleID("3"), "CVE-111-1111 hoge CVE-111-1112 CVE-hoge- CVE-111-1113")
...
func TestAddArticleIDtoCveMap2(t *testing.T) {
	...
	returned := addArticleIDtoCveMap(cves, models.ArticleID("3"), "CVE-111-1111 hoge CVE-111-1112")
